...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('partners.store') }}" method="post" class="p-1" enctype="multipart/form-data">
            @csrf
            <div class="row p-2">
                ...
                <div class="form-group col-6 p-2">
                    <label for="" class="text text-primary"><i class="ri ri-links-line text-info h3"></i>&nbsp;Link
                        Partenaire : <sup class='text text-danger fw-bold '>*</sup>:</label>
                    <input type="text" name="link_partener" id="" class="form-control border-primary"
                        value="{{ old('link_partener') }}">
            ...
            <div class="row p-2">
                <div class="col-8"></div>
                <div class="col-4">
                    <button type="submit" class="btn btn-xs col-12 btn-info">Add Partenaire</button>
                </div>
            </div>
        </form>
    </div>
