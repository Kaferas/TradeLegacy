...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('post_blog.store') }}" method="post" class="p-1" enctype="multipart/form-data">
            @csrf
            <div class="row p-2">
                ...
                <div class="form-group col-12 p-2">
                    <div class="form-check mt-3">
                        ...
                        <label for="" class="text text-primary">Photo Post:<sup
                                class='text text-danger fw-bold '>*</sup>:</label>
                        <input type="file" name="pictures[]" id="" class="form-control border border-secondary custom-file-input"
                            multiple="multiple">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="myeditorinstance" class="tinymce-editor border border-secondary form-control" cols="30" rows="6">
                    </textarea>
