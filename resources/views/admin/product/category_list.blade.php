...
@section('content')
    <div class="container-fluid card mt-2 p-1">
        ...
        <form action="{{ route('category.index') }}" method="get" class="d-flex mb-2">
            @csrf
            ...
            <div class="col-md-1">
                <label for=""></label>
                <a href="{{ route('category.create') }}" class="mt-1 form-control btn btn-sm btn-primary">Add&nbsp;<i
            ...
            <thead>
                ...
                @foreach ($categories as $i => $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('category.edit', $item) }}" class="btn btn-warning btn-sm text-light"><i
                                    class="ri-pencil-fill"></i></a>
                            <form class="d-inline-block" action="{{ route('category.destroy', $item) }}" method="post">
                                @csrf
                                @method('DELETE')
