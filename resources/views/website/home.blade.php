       ...
       <div class="container-fluid about py-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url({{ asset('assets/img/about-img-1.png') }});">
                        <h5 class="section-about-title pe-3">About Us</h5>
                        <h1 class="mb-4">Welcome to <span class="text-primary">Trade Legacy</span></h1>
                        <p class="mb-4">A prosperous Burundi where farmers thrive, youth lead innovation, and sustainable agriculture drives inclusive economic growth across borders.</p>
                        <p class="mb-4">To empower farmers with knowledge, resources, and access to markets through sustainable farming practices, modern technologies, and strategic partnerships—creating a lasting legacy of trade and prosperity.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        ...
                                        <p class="mb-0">Training in modern farming techniques (e.g., irrigation, soil conservation) Transition support from subsistence to commercial farming Environmental sustainability advocacy
                                        </p>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        ...
                                        <p class="mb-0">Farmer training programs and workshops Peer learning and cross-border experience sharing Empowering youth entrepreneurs through mentoring and support
                                        </p>
                                    </div>
                                    <div class="service-icon p-4">
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        ...
                                        <p class="mb-0">Connecting farmers to local and regional markets Leveraging AfCFTA and trade platforms for cross-border opportunities Providing real-time market data and price insights
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        ...
                                        <p class="mb-0">Supply chain strategy and consulting Solutions for infrastructure and transportation challenges Digital platforms for secure payments and logistics tracking
                                        </p>
                                    </div>
                                </div>
                            </div>
